...
module "vnet" {
  ...
  resource_group_name           = "rg-demo-uksouth-01"
  vnetwork_name                 = "vnet-demo-uksouth-001"
  location                      = "uksouth"
...
module "vnet" {
  ...
  # to use an existing resource group, specify the existing resource group name,
  # and set the argument to `create_resource_group = true`. Location will be same as existing RG.
  resource_group_name            = "rg-shared-uksouth-02"
  vnetwork_name                  = "vnet-shared-hub-uksouth-002"
  location                       = "uksouth"
  vnet_address_space             = ["10.1.0.0/16"]
